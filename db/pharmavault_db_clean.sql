...
-- Clean import file for XAMPP/phpMyAdmin
...
CREATE TABLE `brands` (
  ...
  UNIQUE KEY `unique_brand_per_category` (`brand_name`,`cat_id`),
  KEY `idx_category` (`cat_id`),
  KEY `idx_created_by` (`user_id`)
...
CREATE TABLE `products` (
  ...
  KEY `idx_category` (`product_cat`),
  KEY `idx_brand` (`product_brand`),
  KEY `idx_title` (`product_title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
