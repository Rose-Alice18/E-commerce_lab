...
<head>
    ...
    <title>Settings - PharmaVault</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="settings-container">
            <i class="fas fa-cog coming-soon-icon"></i>
            <h3>Settings Page Coming Soon!</h3>
            <p class="text-muted mb-4">You'll be able to configure platform settings, manage permissions, and more.</p>
