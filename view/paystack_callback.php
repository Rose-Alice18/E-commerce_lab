...
<head>
    ...
    <title>Processing Payment - PharmaVault</title>
...
<body>
    <div class="container">
        ...
        <i class="fas fa-check-circle icon-check" id="checkIcon"></i>

        <h1>Verifying Payment</h1>
        <p>Please wait while we verify your payment with Paystack...</p>

        <div class="reference">
            <i class="fas fa-receipt"></i> Payment Reference: <br>
            <strong><?php echo htmlspecialchars($reference); ?></strong>
        </div>

        <div class="error" id="errorBox">
            <strong><i class="fas fa-exclamation-circle"></i> Error:</strong> <span id="errorMessage"></span>
        </div>

        <div class="success" id="successBox">
            <strong><i class="fas fa-check-circle"></i> Success!</strong> Your payment has been verified. Redirecting...
        </div>
    </div>
